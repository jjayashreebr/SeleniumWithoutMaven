...
public class MySelC1 {
	...
	public static void main(String[] args) {
		...
		path = System.getProperty("user.dir") + "/geckodriver.exe";
		System.setProperty("webdriver.gecko.driver", path);

		path = System.getProperty("user.dir") + "/msedgedriver.exe";
		...
		System.out.println("search tagname "+searchIcon.getTagName());
		
		WebDriverWait wait1 = new WebDriverWait(driver, 10);
		WebElement element1 = wait1.until(ExpectedConditions.elementToBeClickable(searchIcon));
		element1.click();
		//searchIcon.click();
		
		driver.get("https://www.facebook.com/");
		System.out.println("face book "+driver.findElement(By.name("email")).getTagName());
